...
class BambuClient(PrinterClient):
    ...
    def __init__(self, config: BambuClientConfig, on_action: Callable[[Action, Any], None]):
    ...
    def on_disconnect(self, client, userdata, disconnect_flags, reason_code, propertie):
